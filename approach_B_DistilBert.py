...
@app.function(image=image, mounts=[modal.Mount.from_local_dir(MOUNT_DIR, remote_path="/workspace")], gpu="a100",timeout=66000, volumes={MODEL_DIR: volume})
def train_model():
    from transformers import DistilBertTokenizer
    import pandas as pd
    ...
    training_set = Triage(balanced_df[0:300000], tokenizer, MAX_LEN)
